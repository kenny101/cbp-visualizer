...
def make_readable(empl, geo_ref, naics_ref):
    ...
    readable = readable.merge(naics_ref, left_on = 'naics', right_on = 'NAICS', how = 'outer')
    #readable['DESCRIPTION'] = readable['DESCRIPTION'].fillna('Sector: nan') #double check this, should i fillna
